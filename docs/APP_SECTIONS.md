...
| Unexpected error dialog | Unexpected Error Dialog | `#exception_message`, `#exception_message_title`, `#exception_log` | Center overlay | Recoverable crash prompt with a warning icon and `Error occured!` title. Press and hold the title to show the crash message. Continue and Clear cache & reload stay equal width. |
