...
| Search field | Place Search Input | `#pac-input` | Top-left, inside `#map_search_bar` | Accepts place names and Wolo Codes while in the map flow and stays focused so typing can begin immediately. CSS shows DIGIPIN and plus-code values in uppercase while the field is `:valid`; other input stays lowercase. |
