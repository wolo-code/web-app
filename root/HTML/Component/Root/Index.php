...
<div id='apple_attribution' class='map_attribution hide blur_background' data-map-layer='apple'>&copy; <a class='link' href='https://www.apple.com/maps/' target='_blank' rel='noopener noreferrer'>Apple</a></div>
...
<div id='map_type_button' class='control hide' tabindex='6' title='Switch map' aria-label='Switch map'>
	<span class='image map_type_icon'>
		<span class='map_type_icon_terrain'><?php includeSVG('', 'Map-terrain'); ?></span>
...
<div id='action_menu' class='control' tabindex='7'>
	...
	<button id='action_menu_toggle' type='button' aria-label='Actions' title='Actions' aria-expanded='false'>
