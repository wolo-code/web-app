...
c.onclick=function(b){b||(b=window.event);b.cancelBubble=!0;b.stopPropagation&&b.stopPropagation();UMB.Widget.hidePersistent(1);return!1};g({display:"block",width:"20px",height:"20px",margin:"0px 0px 0px 40px",padding:"0px",lineHeight:"1.5em",position:"absolute",top:"10px",right:"10px",backgroundImage:"url(//updatemybrowser.org/close.gif)",backgroundPosition:"0 0",backgroundRepeat:"no-repeat"},c);d.appendChild(b);d.appendChild(c);document.getElementsByTagName("body")[0].appendChild(d)},e=function(){var d=
