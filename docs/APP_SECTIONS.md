...
| Modal layer | Overlay Layer | `#overlay`, `onOverlayBackdropClick()` | Full viewport | Hosts info, redirects, city selection, QR, account, crash, and browser-support dialogs. A click on the dimmed overlay outside the open dialog closes it, except Unexpected Error Dialog. |
