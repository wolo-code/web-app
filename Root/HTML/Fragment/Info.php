...
?>
	<button type='button' id='info_version_indicator' class='info_version_toggle' data-version-short='<?php echo htmlspecialchars($appVersionShortLabel, ENT_QUOTES, 'UTF-8') ?>' data-version-full='<?php echo htmlspecialchars($appVersionFullLabel, ENT_QUOTES, 'UTF-8') ?>' data-updated='<?php echo htmlspecialchars($appUpdatedUtc, ENT_QUOTES, 'UTF-8') ?>' aria-expanded='false'><span class='info_version_text'><span class='info_version_width' aria-hidden='true'><?php echo htmlspecialchars($appVersionFullLabel, ENT_QUOTES, 'UTF-8') ?></span><span class='info_version_label'><?php echo htmlspecialchars($appVersionShortLabel, ENT_QUOTES, 'UTF-8') ?></span></span><span class='info_version_under'><span class='info_version_stamp_utc'><?php echo htmlspecialchars($appUpdatedUtc, ENT_QUOTES, 'UTF-8') ?></span><span class='info_version_stamp_elapsed'></span><span class='info_version_local'></span></span></button>
